unRAID Docker Templates for Docker images in the "kieve" repository.
...
2. Enter in a URL of https://github.com/kieve/docker-templates in the "Template repositories" field
